...
interface StepContentProps {
    currentStep: number;
    requestType: 'EMIT' | 'CHANGE' | 'CORRECT' | null;
    steps: { id: string; label: string }[];
    formData: Partial<Policy>;
    handleInputChange: (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement>) => void;
    handleRequestTypeSelect: (type: 'EMIT' | 'CHANGE' | 'CORRECT') => void;
}

function StepContent({ currentStep, requestType, steps, formData, handleInputChange, handleRequestTypeSelect }: StepContentProps) {
    if (currentStep === 0) {
    ...
    return (
        <div className="max-w-4xl mx-auto">
            <div className="mb-8">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                    Completa los siguientes pasos para crear una nueva solicitud de póliza
                </p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
                <form onSubmit={currentStep === steps.length - 1 ? handleSubmit : (e) => { e.preventDefault(); handleNext(); }}>
                    <StepContent
                        ...
                        handleRequestTypeSelect={handleRequestTypeSelect}
                    />
